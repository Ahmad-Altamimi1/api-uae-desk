    ...
    <form method="post" action="{{ route('website-setting.update', 1) }}" enctype="multipart/form-data">
        ...
        <section class="crud-body">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="website-tab" data-toggle="tab" href="#website" role="tab"
                        aria-controls="website" aria-selected="true">Website Setting</a>
                </li>
                {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                        aria-controls="contact" aria-selected="false">Contact Setting</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="allowed_login_distance-tab" data-toggle="tab" href="#allowed_login_distance"
                        role="tab" aria-controls="allowed_login_distance" aria-selected="false">allowed Login Distance
                    </a>
                </li>
                {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="VAT-tab" data-toggle="tab" href="#VAT" role="tab" aria-controls="VAT"
                        aria-selected="false">VAT Setting</a>
                </li>
            </ul>
            <!-- /Tab Menu -->
            ...
            <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="card-body text-center">
                                            <div class="form-group">
                                                <label for="website_title"
                                                    class="required">{{ __('default.form.website_logo_dark') }}:</label>
                                                <div class="">
                                                    @if (!empty($setting->website_logo_dark))
                                                        <img src="{{ $setting->website_logo_dark }}" alt="..."
                                                            id="website_logo_dark_output" class="img-thumbnail rounded mb-3"
                                                            onerror="this.src='{{ asset('assets/admin/img/logo-def.png') }}';">
                                                    @else
                                                        <img src="" alt="..." id="website_logo_dark_output"
                                                            class="img-thumbnail rounded mb-3"
                                                            onerror="this.src='{{ asset('assets/admin/img/logo-def.png') }}';">
                                                    @endif

                                                    <input type="text" hidden id="website_logo_dark" class="form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <div class="form-group">
                                                <label for="website_title"
                                                    class="required">{{ __('default.form.website_logo_light') }}:</label>
                                                <div class="">
                                                    @if (!empty($setting->website_logo_light))
                                                        <img src="{{ $setting->website_logo_light }}" alt="..."
                                                            id="website_logo_light_output"
                                                            class="img-thumbnail rounded mb-3"
                                                            onerror="this.src='{{ asset('assets/admin/img/logo-def.png') }}';"
                                                            style="background-color: #ccc;">
                                                    @else
                                                        <img src="" alt="..." id="website_logo_light_output"
                                                            class="img-thumbnail rounded mb-3"
                                                            onerror="this.src='{{ asset('assets/admin/img/logo-def.png') }}';"
                                                            style="background-color: #ccc;">
                                                    @endif

                                                    <input type="text" hidden id="website_logo_light"
                                                        class="form-control" name="website_logo_light">
                                                    <div class="" style="width: 100%;">
                                                        <button class="btn btn-secondary" type="button"
                                                            id="website_logo_light_button_image">
                                                            <i data-feather="image" class="feather-icon"></i>
                                                            Change Logo Image
                                                        </button>
                                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <div class="form-group">
                                                <label for="website_title"
                                                    class="required">{{ __('default.form.website_logo_small') }}:</label>
                                                <div class="">
                                                    @if (!empty($setting->website_logo_small))
                                                        <img src="{{ $setting->website_logo_small }}" alt="..."
                                                            id="website_logo_output" class="img-thumbnail rounded mb-3"
                                                            onerror="this.src='{{ asset('assets/admin/img/logo-def.png') }}';"
                                                            style="height: 60px;">
                                                    @else
                                                        <img src="" alt="..." id="website_logo_small_output"
                                                            class="img-thumbnail rounded mb-3"
                                                            onerror="this.src='{{ asset('assets/admin/img/logo-sm-default.png') }}';"
                                                            style="height: 60px;">
                                                    @endif

                                                    <input type="text" hidden id="website_logo_small"
                                                        class="form-control" name="website_logo_small">
                                                    <div class="" style="width: 100%;">
                                                        <button class="btn btn-secondary" type="button"
                                                            id="website_logo_small_button_image">
                                                            <i data-feather="image" class="feather-icon"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <div class="form-group">
                                                <label for="website_title"
                                                    class="required">{{ __('default.form.website_favicon') }}:</label>

                                                <div class="">

                                                    @if (!empty($setting->website_favicon))
                                                        <img src="{{ $setting->website_favicon }}" alt="..."
                                                            id="website_favicon_output" class="img-thumbnail rounded mb-3"
                                                            onerror="this.src='{{ asset('assets/admin/img/favicon-def.png') }}';">
                                                    @else
                                                        <img src="" alt="..." id="website_favicon_output"
                                                            class="img-thumbnail rounded mb-3"
                                                            onerror="this.src='{{ asset('assets/admin/img/favicon-def.png') }}';">
                                                    @endif

                                                    <input type="text" hidden id="website_favicon"
                                                        class="form-control" name="website_favicon">
                                                    <div class="" style="width: 100%;">
                                                        <button class="btn btn-secondary" type="button"
                                                            id="website_favicon_button_image">
                                                            <i data-feather="image" class="feather-icon"></i>
                                ...
                                <select name="currency_id" id="currency_id" class="form-control"
                                    ...
                                    @foreach ($currencies as $currency)
                                        <option value="{{ $currency->id }}"
                                            @if ($currency->id == $setting->currency_id) selected @endif>{{ $currency->name }}
                                            ({{ $currency->code }})
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="github" id="github" class="form-control"
                                    @error('instagram') form-control-error @enderror" value="{{ $setting->github }}">
                ...
                <div class="tab-pane fade" id="VAT" role="tabpanel" aria-labelledby="VAT-tab">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="vat_value">{{ __('VAT Value (%)') }}</label>
                                <input type="number" name="vat_value" id="vat_value" step="0.01"
                                    class="form-control @error('vat_value') form-control-error @enderror"
                                    value="{{ old('vat_value', $setting->vat_value ?? '') }}"
                ...
                <!-- VAT Setting -->
                <!-- allowed_login_distance Setting -->
                <div class="tab-pane fade" id="allowed_login_distance" role="tabpanel"
                    aria-labelledby="allowed_login_distance-tab">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">
                                allowed Login Distance Setting
                            </h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="allowed_login_distance">{{ __('default.form.allowed_login_distance') }}
                                    :</label>
                                <input type="number" name="allowed_login_distance" id="allowed_login_distance"
                                    class="form-control @error('allowed_login_distance') form-control-error @enderror"
                                    value="{{ $setting->allowed_login_distance }}">

                                @error('allowed_login_distance')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
