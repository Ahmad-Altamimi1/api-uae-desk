...
<div class="header">
    ...
    <ul class="nav user-menu">
        ...
        <!-- /Notifications -->
        <div id="google_translate_element" style="margin: 10px; background-color: #f9f9f9; padding: 10px; border: 1px solid #ddd;"></div>
...
<script type="text/javascript">
    function googleTranslateElementInit() {
        new google.translate.TranslateElement({
            ...
            includedLanguages: 'ar,ar-AE', // Allow both Standard Arabic and UAE Arabic
