                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('user.create.title') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row equal-height">
                    ...
                    <div class="col-md-4 col-sm-12 text-center mb-4 m-auto">
                        <img src="" id="output" class="img-thumbnail rounded-circle mb-3"
                        ...
                        <button type="button" class="btn btn-secondary w-100" id="button-image">
                            <i data-feather="image" class="me-1"></i> {{ __('Select User\'s Image') }}
                        </button>
                    </div>
                </div>
                <div class="row equal-height mt-3">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    <label for="mobile"
                                        class="form-label required">{{ __('default.form.mobile') }}:</label>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group mb-3">
                                    <label for="email"
                                        class="form-label required">{{ __('default.form.email') }}:</label>
                                ...
                                <div class="form-group mb-3">
                                    <label for="password"
                                        class="form-label required">{{ __('default.form.password') }}:</label>
                                ...
                                <div class="form-group mb-3">
                                    <label for="password-confirm"
                                        class="form-label required">{{ __('default.form.password-confirm') }}:</label>
                                    <input type="password" name="confirm-password" id="password-confirm"
                                        class="form-control @error('confirm-password') is-invalid @enderror" required>
                    ...
                    <!-- Role, Branch, and Location Section -->
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header bg-secondary text-white">Role/Shift</div>
                            <div class="card-body">
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3" id="location-section" style="display: none;">
                                    <label for="location_id" class="form-label required">{{ __('Location') }}:</label>
                                ...
                                <div class="form-group" id="branch-section" style="display: none;">
                                    <label for="branch_id" class="form-label required">{{ __('Branch') }}:</label>
                                ...
                                <div class="form-group form-check">
                                    <input class="form-check-input" type="checkbox" name="is_location_flexible"
                                        id="is_location_flexible" {{ old('is_location_flexible') ? 'checked' : '' }}>
